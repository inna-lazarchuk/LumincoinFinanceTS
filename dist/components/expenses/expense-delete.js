...
exports.ExpenseDelete = void 0;
var expenses_service_1 = require("../../services/expenses-service");
var ExpenseDelete = /** @class */ (function () {
    function ExpenseDelete(openNewRoute) {
        var _this = this;
        ...
        if (this.buttonNoElement) {
            this.buttonNoElement.addEventListener('click', function () {
                localStorage.removeItem('categoryId');
                _this.openNewRoute('/expenses');
            });
        }
    }
    ExpenseDelete.prototype.deleteFunction = function () {
        return __awaiter(this, void 0, void 0, function () {
            var successDelete;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, expenses_service_1.ExpensesService.deleteExpenseCategory(this.id)];
                    case 1:
...
//# sourceMappingURL=expense-delete.js.map