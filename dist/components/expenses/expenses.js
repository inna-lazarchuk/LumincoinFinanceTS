...
var Expenses = /** @class */ (function () {
    ...
    Expenses.prototype.getAllCategoriesExpenses = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, expenses_service_1.ExpensesService.getCategories()];
                    case 1:
                        response = _a.sent();
                        if (response.error) {
    ...
    Expenses.prototype.showCategories = function (categories) {
        var _this = this;
        ...
        categories.forEach(function (category) {
            ...
            buttonEditElement.addEventListener('click', function () {
                ...
                _this.openNewRoute('/expense-edit');
            });
            ...
            buttonDeleteElement.addEventListener('click', function () {
                localStorage.setItem('categoryId', category.id.toString());
                _this.openNewRoute('/expense-delete');
            });
        ...
        categoryLastElement.addEventListener('click', function () { return _this.openNewRoute('/expense-create'); });
    };
    return Expenses;
}());
