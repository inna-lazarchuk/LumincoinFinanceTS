...
var ExpenseCreate = /** @class */ (function () {
    ...
    ExpenseCreate.prototype.createCategory = function (e) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expenses_service_1.ExpensesService.createCategory(titleCategory.value)];
                    case 1:
                        result = _a.sent();
                        if (result.error) {
...
//# sourceMappingURL=expense-create.js.map