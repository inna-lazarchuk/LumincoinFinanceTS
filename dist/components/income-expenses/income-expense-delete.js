...
exports.IncomeExpenseDelete = void 0;
var operations_service_1 = require("../../services/operations-service");
var IncomeExpenseDelete = /** @class */ (function () {
    function IncomeExpenseDelete(openNewRoute) {
        var _this = this;
        ...
        if (this.buttonNoElement) {
            this.buttonNoElement.addEventListener('click', function () { return _this.openNewRoute('/income-expenses'); });
        }
    }
    IncomeExpenseDelete.prototype.deleteFunction = function () {
        return __awaiter(this, void 0, void 0, function () {
            var successDelete;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, operations_service_1.OperationsService.deleteIncomeExpenseCategory(this.id)];
                    case 1:
    ...
    return IncomeExpenseDelete;
}());
exports.IncomeExpenseDelete = IncomeExpenseDelete;
//# sourceMappingURL=income-expense-delete.js.map