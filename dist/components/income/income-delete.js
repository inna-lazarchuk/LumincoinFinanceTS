...
exports.IncomeDelete = void 0;
var income_service_1 = require("../../services/income-service");
var IncomeDelete = /** @class */ (function () {
    function IncomeDelete(openNewRoute) {
        var _this = this;
        ...
        if (this.buttonNoElement) {
            this.buttonNoElement.addEventListener('click', function () {
                ...
                _this.openNewRoute('/income');
            });
        }
    }
    IncomeDelete.prototype.deleteFunction = function () {
        return __awaiter(this, void 0, void 0, function () {
            var successDelete;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, income_service_1.IncomeService.deleteIncomeCategory(this.id)];
                    case 1:
...
//# sourceMappingURL=income-delete.js.map