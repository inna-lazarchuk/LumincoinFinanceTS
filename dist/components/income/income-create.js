...
var IncomeCreate = /** @class */ (function () {
    ...
    IncomeCreate.prototype.createCategory = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            var titleCategory, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        e.preventDefault();
                        titleCategory = document.getElementById('nameCategoryIncome');
                        return [4 /*yield*/, income_service_1.IncomeService.createCategory(titleCategory.value)];
                    case 1:
                        result = _a.sent();
                        if (result.error) {
...
//# sourceMappingURL=income-create.js.map