...
var IncomeEdit = /** @class */ (function () {
    function IncomeEdit(openNewRoute) {
        ...
        if (this.buttonCancelElement) {
            this.buttonCancelElement.addEventListener('click', function () { return _this.openNewRoute('/income'); });
        }
    }
    IncomeEdit.prototype.getCategory = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result, createBlock, inputElement, actionsElement, buttonSaveElement, buttonCancelElement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, income_service_1.IncomeService.getCategory(id)];
                    case 1:
                        result = _a.sent();
    ...
    IncomeEdit.prototype.editCategory = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, income_service_1.IncomeService.editCategory(id, newTitleCategory)];
                    case 1:
                        result = _a.sent();
                        if (result.error) {
                            console.log('Ошибка запроса');
...
//# sourceMappingURL=income-edit.js.map