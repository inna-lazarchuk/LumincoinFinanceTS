...
var IncomeService = /** @class */ (function () {
    ...
    IncomeService.getCategories = function () {
    ...
    IncomeService.getCategory = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var returnObject, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, http_utils_1.HttpUtils.request('/categories/income/' + id)];
                    case 1:
                        result = _a.sent();
                        if (result.error || !result) {
    ...
    IncomeService.createCategory = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, http_utils_1.HttpUtils.request('/categories/income', "POST", true, changedData)];
                    case 1:
                        result = _a.sent();
                        if (result.error || !result) {
    ...
    IncomeService.editCategory = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, http_utils_1.HttpUtils.request('/categories/income/' + id, "PUT", true, changeData)];
                    case 1:
                        result = _a.sent();
                        if (result.error || !result) {
    ...
    IncomeService.deleteIncomeCategory = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, http_utils_1.HttpUtils.request('/categories/income/' + id, "DELETE", true)];
                    case 1:
                        result = _a.sent();
                        if (result.error || !result) {
